...
export default class CinematicSequenceEditor extends React.Component {
  ...
  _saveTracks(tracks) {
    ...
    try {
      Tracer.traceEvent('cinematic_save_attempt', {
    ...
    try {
      Tracer.traceEvent('cinematic_save', { tracksCount: tracks.length });
    } catch (e) {}
  }
  ...
  _play = () => {
    ...
    try {
      Tracer.traceEvent('cinematic_play', { time: this.state.currentTime });
    } catch (e) {}
  ...
  _stop = () => {
    ...
    try {
      Tracer.traceEvent('cinematic_stop', { time: this.state.currentTime });
    } catch (e) {}
  };
